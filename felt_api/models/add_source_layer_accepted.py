...
class AddSourceLayerAccepted(BaseModel):
    """
    AddSourceLayerAccepted
    """ # noqa: E501
    links: Optional[AddSourceLayerAcceptedLinks] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["links", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": AddSourceLayerAcceptedLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
