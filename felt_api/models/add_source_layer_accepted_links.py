...
class AddSourceLayerAcceptedLinks(BaseModel):
    """
    AddSourceLayerAcceptedLinks
    """ # noqa: E501
    layer_group: Optional[StrictStr] = None
    var_self: Optional[StrictStr] = Field(default=None, alias="self")
    __properties: ClassVar[List[str]] = ["layer_group", "self"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "layer_group": obj.get("layer_group"),
            "self": obj.get("self")
        })
        return _obj
