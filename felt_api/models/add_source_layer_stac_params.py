...
class AddSourceLayerSTACParams(BaseModel):
    """
    AddSourceLayerSTACParams
    """ # noqa: E501
    var_from: StrictStr = Field(alias="from")
    source_id: StrictStr
    stac_asset_url: StrictStr
    __properties: ClassVar[List[str]] = ["from", "source_id", "stac_asset_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stac_asset_url": obj.get("stac_asset_url")
        })
        return _obj
