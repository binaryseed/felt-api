...
class Admin0AttributeHint(BaseModel):
    """
    ...
    """ # noqa: E501
    attribute: Admin0AttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": Admin0AttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
