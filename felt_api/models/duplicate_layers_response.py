...
class DuplicateLayersResponse(BaseModel):
    """
    DuplicateLayersResponse
    """ # noqa: E501
    layer_groups: List[LayerGroup2]
    layers: List[Layer2]
    __properties: ClassVar[List[str]] = ["layer_groups", "layers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "layer_groups": [LayerGroup2.from_dict(_item) for _item in obj["layer_groups"]] if obj.get("layer_groups") is not None else None,
