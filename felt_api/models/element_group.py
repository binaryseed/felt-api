...
class ElementGroup(BaseModel):
    ...
    ElementGroup
    """ # noqa: E501
    color: StrictStr = Field(description="The color of the element group symbol.")
    elements: GeoJSON
    id: StrictStr = Field(description="The ID of the element group.")
    name: Optional[StrictStr] = Field(description="The name of the element group.")
    symbol: Optional[StrictStr] = Field(description="The symbol used to represent the element group.")
    __properties: ClassVar[List[str]] = ["color", "elements", "id", "name", "symbol"]
