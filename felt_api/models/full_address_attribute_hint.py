...
class FullAddressAttributeHint(BaseModel):
    """
    A hint that the data contains a full Address contained in a single attribute.
    """ # noqa: E501
    attribute: FullAddressAttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": FullAddressAttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
