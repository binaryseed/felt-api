...
class GeoJSONFeaturesInner(BaseModel):
    """
    GeoJSONFeaturesInner
    """ # noqa: E501
    geometry: Optional[GeoJSONFeaturesInnerGeometry] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geometry": GeoJSONFeaturesInnerGeometry.from_dict(obj["geometry"]) if obj.get("geometry") is not None else None,
