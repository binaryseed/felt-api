...
class H3AttributeHint(BaseModel):
    """
    A hint that the data contains H3 attribute.
    """ # noqa: E501
    attribute: H3AttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": H3AttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
