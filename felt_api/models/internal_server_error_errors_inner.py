...
class InternalServerErrorErrorsInner(BaseModel):
    """
    InternalServerErrorErrorsInner
    """ # noqa: E501
    detail: Optional[StrictStr] = None
    source: Optional[InternalServerErrorErrorsInnerSource] = None
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["detail", "source", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": InternalServerErrorErrorsInnerSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "title": obj.get("title")
        })
        return _obj
