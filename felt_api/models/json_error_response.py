...
class JsonErrorResponse(BaseModel):
    ...
    JsonErrorResponse
    """ # noqa: E501
    errors: List[JsonErrorResponseErrorsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [JsonErrorResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
