...
class JsonErrorResponseErrorsInner(BaseModel):
    """
    JsonErrorResponseErrorsInner
    """ # noqa: E501
    detail: StrictStr
    source: JsonErrorResponseErrorsInnerSource
    title: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": JsonErrorResponseErrorsInnerSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "title": obj.get("title")
        })
        return _obj
