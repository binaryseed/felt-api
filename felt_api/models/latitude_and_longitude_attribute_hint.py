...
class LatitudeAndLongitudeAttributeHint(BaseModel):
    """
    A hint that the data contains Latitude and Longitude in two individual attributes.
    """ # noqa: E501
    attributes: LatitudeAndLongitudeAttributeHintAttributes
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": LatitudeAndLongitudeAttributeHintAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
