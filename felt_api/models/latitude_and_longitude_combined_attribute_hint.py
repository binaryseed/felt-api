...
class LatitudeAndLongitudeCombinedAttributeHint(BaseModel):
    """
    A hint that the data contains Latitude and Longitude combined in a single attribute.
    """ # noqa: E501
    attribute: LatitudeAndLongitudeCombinedAttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": LatitudeAndLongitudeCombinedAttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
