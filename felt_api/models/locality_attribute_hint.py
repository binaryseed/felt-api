...
class LocalityAttributeHint(BaseModel):
    """
    A hint that the data contains a Locality spread out over multiple attributes.
    """ # noqa: E501
    attributes: LocalityAttributeHintAttributes
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": LocalityAttributeHintAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
