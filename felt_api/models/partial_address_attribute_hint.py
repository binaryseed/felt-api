...
class PartialAddressAttributeHint(BaseModel):
    """
    A hint that the data contains an Address spread out over multiple attributes.
    """ # noqa: E501
    attributes: PartialAddressAttributeHintAttributes
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": PartialAddressAttributeHintAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
