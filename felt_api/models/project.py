...
class Project(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr
    maps: List[MapReference1]
    name: StrictStr
    type: StrictStr
    visibility: StrictStr
    __properties: ClassVar[List[str]] = ["id", "maps", "name", "type", "visibility"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "maps": [MapReference1.from_dict(_item) for _item in obj["maps"]] if obj.get("maps") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type"),
