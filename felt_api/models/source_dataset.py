...
class SourceDataset(BaseModel):
    ...
    geometry_type: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    inspection_status: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    updated_at: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["created_at", "description", "geometry_type", "id", "inspection_status", "name", "type", "updated_at"]
    ...
    def geometry_type_validate_enum(cls, value):
        ...
        if value not in set(['polygon', 'line', 'point', 'raster', 'none']):
            raise ValueError("must be one of enum values ('polygon', 'line', 'point', 'raster', 'none')")
        return value

    @field_validator('inspection_status')
    def inspection_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
