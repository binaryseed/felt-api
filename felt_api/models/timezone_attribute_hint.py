...
class TimezoneAttributeHint(BaseModel):
    """
    A hint that the data contains a Timezone attribute.
    """ # noqa: E501
    attribute: TimezoneAttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": TimezoneAttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
