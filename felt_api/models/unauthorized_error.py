...
class UnauthorizedError(BaseModel):
    ...
    UnauthorizedError
    """ # noqa: E501
    errors: Optional[List[UnauthorizedErrorErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [UnauthorizedErrorErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
