...
class UnauthorizedErrorErrorsInner(BaseModel):
    """
    UnauthorizedErrorErrorsInner
    """ # noqa: E501
    detail: Optional[StrictStr] = None
    source: Optional[UnauthorizedErrorErrorsInnerSource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "source": UnauthorizedErrorErrorsInnerSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
            "title": obj.get("title")
        })
        return _obj
