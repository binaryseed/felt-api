...
class USState2020AttributeHint(BaseModel):
    """
    A hint that the data contains a US State (Census 2020) attribute.
    """ # noqa: E501
    attribute: USState2020AttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": USState2020AttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
