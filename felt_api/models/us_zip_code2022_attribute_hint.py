...
class USZipCode2022AttributeHint(BaseModel):
    """
    A hint that the data contains US Zip Code (2022) attribute.
    """ # noqa: E501
    attribute: USZipCode2022AttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": USZipCode2022AttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
