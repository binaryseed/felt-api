...
class WKTWKBLiteralAttributeHint(BaseModel):
    """
    A hint that the data contains a WKT/WKB Literal attribute
    """ # noqa: E501
    attribute: WKTWKBLiteralAttributeHintAttribute
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attribute": WKTWKBLiteralAttributeHintAttribute.from_dict(obj["attribute"]) if obj.get("attribute") is not None else None
        })
        return _obj
